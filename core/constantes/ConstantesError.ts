...
export default class ConstantesError {
    public static ERROR_NIVEL_VACIO: string = 'Error al inicializar el nivel. El nivel no contiene objetos.';
    ...
    public static ERROR_ID_NIVEL: string = 'El id del nivel no se ha encontrado.';
    public static ERROR_NOMBRE_NIVEL: string = 'El nombre del nivel no se ha encontrado.';
    public static ERROR_ID_NIVEL_INEXISTENTE: string = 'El id proporcionado no corresponde con ningun nivel.';
